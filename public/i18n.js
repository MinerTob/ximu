...
window.I18N = (function () {
  const zhCN = {
    ...
    noViolationReply: '我们收到了您的检举。经核实，未发现违规行为，我们会重点关注该账号近期的行为。感谢您的监督。',
  ...
  const zhTW = {
    ...
    noViolationReply: '我們收到了您的檢舉。經核實，未發現違規行為，我們會重點關注該帳號近期的行為。感謝您的監督。',
  ...
  const en = {
    ...
    noViolationReply: 'We received your report. After review, no violation was found. We will keep an eye on this account. Thank you for reporting.',
